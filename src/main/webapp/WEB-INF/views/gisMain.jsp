	...
	<div class="grid-container">
		<div class="grid-1">
			<div class="sidebar">
				...
				<div>
					<div>
						<input type="checkbox" name="wmsLayerCheckbox1"
							value="te_scco_sid_wms" id="te_scco_sid_wms" /> 
							<label for="te_scco_sid_wms">te_scco_sid_wms 조회</label>
					</div>
					<div>
						<input type="checkbox" name="wfsLayerCheckbox2"
							value="te_scco_sgg_ln_wms" id="te_scco_sgg_ln_wms" /> 
